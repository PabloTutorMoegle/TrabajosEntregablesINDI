...
{	
  ...
  vec3 diffuseComponent = Difus(NormSCO, L, colorFocus);
  vec3 especularComponent = Especular(NormSCO, L, vertexSCO, colorFocus);

  fcolor = ambientComponent + diffuseComponent + especularComponent;
